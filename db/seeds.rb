...
# 問題とクラスの割当
LessonQuestion.create(:lesson_id => 1, :question_id => 1, :start_time => (Date.today - 7).to_s, :end_time => (Date.today - 1).to_s)
LessonQuestion.create(:lesson_id => 1, :question_id => 2, :start_time => (Date.today - 3).to_s, :end_time => (Date.today + 4).to_s)
LessonQuestion.create(:lesson_id => 1, :question_id => 3, :start_time => (Date.today + 7).to_s, :end_time => (Date.today + 10).to_s)
...
Answer.create(:student_id => 7, :lesson_id => 1, :question_id => 2, :file_name => "version1.txt", :language => "c", :result => 1, :run_time => 0.1, :memory_usage => 5, :cpu_usage => 7, :plagiarism_percentage => 0.1)
...
# クラス1の残りの学生
(9..14).each do |i|
  Answer.create(:student_id => i, :lesson_id => 1, :question_id => 1, :file_name => "version1.txt", :language => "c", :result => 1, :run_time => 3, :memory_usage => 50, :cpu_usage => 10, :plagiarism_percentage => 0.3)
end
